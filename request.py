...
class Request(object):
	...
	def query(self, query, dictionary, fields, filters = None, output = 'json', method = 'GET'):
		...
		# no support for output <> json nor method <> GET
		...
		# check for proper field definition/type #
		...
		# create dictionary of fields and filters (if relevant) #
		params = {}
	...
	def __buildQueryParams(self, params):
		...
		for m in params.itervalues():
			if isinstance(m, type([])):
				...
				raise TypeError("Your input is neither an array of fields nor a hash of filters.")
		if filter_list != []:
	...
	# creates StringToSign, which itself goes into the signature in the header
